:: WARNING: This is a generated template from validate_hashes.ps1 (Source Folder: 990_Project_Automation_Automation_Scripts_bak)
...
if ($ManifestPath -ne "") {
    ...
    # Scan all manifests in __ECOSYSTEM_ROOT__
    $ecosystemRoot = "__ECOSYSTEM_ROOT__"
