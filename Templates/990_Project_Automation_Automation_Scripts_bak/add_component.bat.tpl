:: WARNING: This is a generated template from add_component.bat (Source Folder: 990_Project_Automation_Automation_Scripts_bak)
...
echo Target Root: __INSTALL_ROOT__\%PROJECT_ROOT%
echo ===================================================
