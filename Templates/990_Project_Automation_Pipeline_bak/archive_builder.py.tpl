:: WARNING: This is a generated template from archive_builder.py (Source Folder: 990_Project_Automation_Pipeline_bak)
...
ARCHIVE_ROOT = Path(r"__ECOSYSTEM_ROOT__\995_Project_Logs\DML_Archives")
