...
echo E:\NextGen\Offline_IT_Ecosystem\210_Project_Dev_Tools\Summarize\output
echo.

REM Set project paths
set "PROJECT_ROOT=E:\NextGen\Offline_IT_Ecosystem\210_Project_Dev_Tools\Summarize"
...
python --version
echo.
echo Source: E:\NextGen\Offline_IT_Ecosystem\200_Content_Data_Source
...
if %EXIT_CODE% equ 0 (
    ...
    echo E:\NextGen\Offline_IT_Ecosystem\995_Project_Logs
    echo.
